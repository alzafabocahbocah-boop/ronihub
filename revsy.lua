...
warn("[ZenxLvl] versi: "..SCRIPT_VERSION.." (swap mechanic: friend-7 + gift/trade FIXED)")
...
print("ZenxLvl "..SCRIPT_VERSION.." loaded! v8.2: gift/trade FIXED (PetGiftingService.GivePet + TradeEvents.SendRequest/AddItem)")
